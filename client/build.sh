...
${nuget_cmd} install src/Cloudmersive.APIClient.NET.VideoAndMediaServices/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Cloudmersive.APIClient.NET.VideoAndMediaServices.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Cloudmersive.APIClient.NET.VideoAndMediaServices.dll \
-recurse:'src/Cloudmersive.APIClient.NET.VideoAndMediaServices/*.cs' \
-doc:bin/Cloudmersive.APIClient.NET.VideoAndMediaServices.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Cloudmersive.APIClient.NET.VideoAndMediaServices.dll was created successfully"
fi
